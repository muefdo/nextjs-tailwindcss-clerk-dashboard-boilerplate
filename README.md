# 🚀 Next.js + ReactJS + TS + Tailwind CSS + ShadcnUI+ Prisma ORM + Clerk Authentication Dashboard Boilerplate
...
## I also write some Next.js server actions with prisma, you can check it out details
