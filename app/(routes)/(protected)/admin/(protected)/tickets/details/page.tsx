...
import OneLineSkeletonLoader from '@/components/ui/oneLineSkeletonLoader';
      ...
      <div className='grid grid-cols-1 gap-8 sm:grid-cols-2'>
        <div className='space-y-4'>
          <div className='space-y'>
            ...
            <p className='text-gray-500 text-2xl font-bold dark:text-gray-400'>
          ...
          <div className='space-y-3 overflow-auto h-[20rem] max-h-[20rem] md:h-[35rem] md:max-h-[35rem] scrollbar-hide scrollbar-thin '>
            {Array.isArray(messages) ? (
              messages.map((message: Message, index: number) => (
                <div
                  key={index}
                  className={`flex flex-col space-y-2  w-full p-4 text-left rounded-lg  dark:bg-gray-800 focus:outline-none ${
